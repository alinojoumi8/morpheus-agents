#!/usr/bin/env python3
"""
SWE Runner with Morpheus Trajectory Format

A runner that uses Morpheus-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Morpheus-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Morpheus-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Morpheus format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Morpheus-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Morpheus-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Morpheus Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Morpheus-Agent's built-in execution environments
    and outputs trajectories in Morpheus-Agent format.
    """
    ...
    def _convert_to_morpheus_format(
        ...
        """
        Convert internal message format to Morpheus trajectory format.
...
def main(
    ...
    """
    Run SWE tasks with Morpheus trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Morpheus Trajectory Format")
    print("=" * 60)
