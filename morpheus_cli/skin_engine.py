"""Morpheus CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.morpheus/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    from morpheus_cli.skin_engine import get_active_skin, list_skins, set_active_skin
...
Drop a YAML file in ``~/.morpheus/skins/<name>.yaml`` following the schema above.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Morpheus — gold and kawaii",
        "colors": {
...
def _skins_dir() -> Path:
    ...
    return get_morpheus_home() / "skins"
