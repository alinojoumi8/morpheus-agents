...
from morpheus_cli.config import get_morpheus_home, get_config_path, load_config, save_config
...
def _cmd_migrate(args):
    """Run the OpenClaw → Morpheus migration."""
