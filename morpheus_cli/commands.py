"""Slash command definitions and autocomplete for the Morpheus CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("paste", "Check clipboard for an image and attach it", "Info",
               cli_only=True),
    CommandDef("update", "Update Morpheus Agent to the latest version", "Info",
               gateway_only=True),
...
def _resolve_config_gates() -> set[str]:
    ...
    try:
        ...
        config_path = os.path.join(
            os.getenv("MORPHEUS_HOME", os.path.expanduser("~/.morpheus")),
            "config.yaml",
        )
