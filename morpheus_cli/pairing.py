...
Usage:
    morpheus pairing list              # Show all pending + approved users
    morpheus pairing approve <platform> <code>  # Approve a pairing code
    morpheus pairing revoke <platform> <user_id> # Revoke user access
    morpheus pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle morpheus pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: morpheus pairing {list|approve|revoke|clear-pending}")
        print("Run 'morpheus pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'morpheus pairing list' to see pending codes.\n")
