...
sidebar_position: 8
title: "SMS (Twilio)"
description: "Set up Morpheus Agent as an SMS chatbot via Twilio"
---

# SMS Setup (Twilio)

Morpheus connects to SMS through the [Twilio](https://www.twilio.com/) API. People text your Twilio phone number and get AI responses back — same conversational experience as Telegram or Discord, but over standard text messages.
...
- **aiohttp** — `pip install 'morpheus-agent[sms]'`
...
If you're running Morpheus locally, use a tunnel to expose the webhook:
...
Text your Twilio number — Morpheus will respond via SMS.
...
3. Check Morpheus gateway logs for Twilio API errors
