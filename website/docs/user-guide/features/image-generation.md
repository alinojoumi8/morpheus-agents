...
Morpheus Agent can generate images from text prompts using FAL.ai's **FLUX 2 Pro** model with automatic 2x upscaling via the **Clarity Upscaler** for enhanced quality.
...
When you ask Morpheus to generate an image:
...
Simply ask Morpheus to create an image:
