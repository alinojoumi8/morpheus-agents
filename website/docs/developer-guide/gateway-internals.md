...
The messaging gateway is the long-running process that connects Morpheus to external platforms.
...
- `~/.morpheus/gateway.json`
- selected bridged values from `~/.morpheus/config.yaml`
