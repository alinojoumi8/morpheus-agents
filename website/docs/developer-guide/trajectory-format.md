...
description: "How Morpheus saves trajectories, normalizes tool calls, and produces training-friendly outputs"
---

# Trajectories & Training Format

Morpheus can save conversation trajectories for training, evaluation, and batch data generation workflows.
...
Morpheus converts live conversation structure into a training-friendly format.
