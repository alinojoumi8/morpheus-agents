...
metadata:
  morpheus:
    ...
    related_skills: [claude-code, morpheus-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Morpheus terminal. Codex is OpenAI's autonomous coding agent CLI.
