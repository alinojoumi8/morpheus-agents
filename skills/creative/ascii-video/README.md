...
Built for [Morpheus Agent](https://github.com/NousResearch/morpheus-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/morpheus-agent/skills/creative/ascii-video`](https://github.com/NousResearch/morpheus-agent/tree/main/skills/creative/ascii-video) via PR.
