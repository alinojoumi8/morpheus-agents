...
```bash
python3 -m pyfiglet "MORPHEUS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=MORPHEUS&font=Slant" | boxes -d stone
```
