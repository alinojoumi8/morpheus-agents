...
DEFAULT_DATASETS = [
    ...
    "NousResearch/morpheus-agent-megascience-sft1",
    "NousResearch/Morpheus-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Morpheus-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-morpheus-agent"
]
