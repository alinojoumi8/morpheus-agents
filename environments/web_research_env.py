...
Inspired by: GroceryMind — production morpheus agent doing live web research
             across German grocery stores (firecrawl + morpheus-agent)
"""
...
# Ensure morpheus-agent root is on path
...
class WebResearchEnvConfig(MorpheusAgentEnvConfig):
...
class WebResearchEnv(MorpheusAgentBaseEnv):
    """
