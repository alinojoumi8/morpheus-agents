...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("morpheus")
        class MorpheusToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "morpheus", "mistral", "llama3_json")
...
from environments.tool_call_parsers.morpheus_parser import MorpheusToolCallParser  # noqa: E402, F401
