"""
Timezone-aware clock for Morpheus.
...
Invalid timezone values log a warning and fall back safely — Morpheus never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Morpheus requires 3.9+)
