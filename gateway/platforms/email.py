"""
Email platform adapter for the Morpheus gateway.

Allows users to interact with Morpheus by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Morpheus Agent")
        ...
        msg_id = f"<morpheus-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
