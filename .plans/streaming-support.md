# Streaming LLM Response Support for Morpheus Agent
...
```
MORPHEUS_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("MORPHEUS_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `morpheus_cli/config.py` | 1 | +streaming config defaults |
...
MORPHEUS_STREAMING_ENABLED=true
```
