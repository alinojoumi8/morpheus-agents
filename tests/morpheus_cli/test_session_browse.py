"""Tests for the interactive session browser (`morpheus sessions browse`).
...
from morpheus_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """morpheus sessions browse should be parseable."""
        from morpheus_cli.main import main as _main_entry
