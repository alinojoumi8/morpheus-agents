...
Validates that:
1. The installed atroposlib API still matches Morpheus's expectations
2. Morpheus's parser registry remains compatible with ManagedServer parsing
3. MorpheusAgentBaseEnv wires the selected parser into ServerManager correctly

These tests verify the contract between morpheus-agent's environments/ code
...
class TestManagedServerAPI:
    """Test that ManagedServer's API matches what morpheus-agent expects."""
...
class TestParserCompatibility:
    """Test that morpheus-agent's parsers match ManagedServer's expectations."""
