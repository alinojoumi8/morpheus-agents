...
class TestSetupProviderModelSelection:
    ...
    @patch("morpheus_cli.models.fetch_api_models", return_value=[])
    @patch("morpheus_cli.config.get_env_value", return_value="fake-key")
    def test_falls_back_to_default_models_without_crashing(
        ...
        from morpheus_cli.setup import _setup_provider_model_selection
        ...
        with patch("morpheus_cli.auth.PROVIDER_REGISTRY", mock_provider_registry):
    ...
    @patch("morpheus_cli.models.fetch_api_models")
    @patch("morpheus_cli.config.get_env_value", return_value="fake-key")
    ...
    def test_custom_model_selection(
        ...
        from morpheus_cli.setup import _setup_provider_model_selection, _DEFAULT_PROVIDER_MODELS
